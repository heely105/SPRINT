...
#define DXL_FIRST_ID                    0       // ID of left rear motor
#define DXL_SECOND_ID                   1       // ID of right rear motor
#define DXL_THIRD_ID                    2       // ID of left front motor
...
class Turtlebot3MotorDriver
{
 public:
  ...
  bool readEncoder(int32_t &first_value, int32_t &second_value, int32_t &third_value);
