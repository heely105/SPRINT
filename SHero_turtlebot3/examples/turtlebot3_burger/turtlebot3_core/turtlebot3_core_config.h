...
int32_t last_diff_tick[WHEEL_NUM] = {0, 0, 0};
...
float zero_velocity[WHEEL_NUM] = {0.0, 0.0, 0.0};
float goal_velocity[WHEEL_NUM] = {0.0, 0.0, 0.0};
float goal_velocity_from_button[WHEEL_NUM] = {0.0, 0.0, 0.0};
float goal_velocity_from_cmd[WHEEL_NUM] = {0.0, 0.0, 0.0};
float goal_velocity_from_rc100[WHEEL_NUM] = {0.0, 0.0, 0.0};
